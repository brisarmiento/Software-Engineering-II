  ...
  <body id="page-top">
    ...
    >
      <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="#page-top">BLEM Banking</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto my-2 my-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./pages/admin_pages/admin_signin.php"
                >Staff Services</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./pages/cust_pages/customer_signin.php"
                >Login</a
              >
            </li>
          </ul>
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <a
              ...
              href="./pages/cust_pages/customer_register.php"
              >Register Now!</a
            >
          </div>
        </div>
    ...
    <footer class="bg-light py-5">
      <div class="container px-4 px-lg-5">
        <div class="small text-center text-muted">
          Copyright &copy; 2022 - BLEM Banking
        </div>
      </div>
    </footer>
    <!-- Bootstrap core JS-->
